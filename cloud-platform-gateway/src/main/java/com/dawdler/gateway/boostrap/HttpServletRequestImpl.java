...
public class HttpServletRequestImpl implements HttpServletRequest{
	public HttpServletRequestImpl(ServerHttpRequest request) {
	...
	public Cookie[] getCookies() {
		...
		Collection<List<HttpCookie>> collection = request.getCookies().values();
		for(List<HttpCookie> cookies : collection) {
